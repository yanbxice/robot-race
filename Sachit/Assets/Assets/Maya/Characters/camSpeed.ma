...
//Name: camSpeed.ma
//Last modified: Fri, Oct 28, 2011 04:50:40 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.659995058016278 0.31314833640534279 -0.06524775273510694 ;
	setAttr ".r" -type "double3" 182.64671455933046 271.80751837618817 -179.99999991966462 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100000;
	setAttr ".fd" 152.4;
	setAttr ".coi" 12.680049495201846;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode joint -n "camSpeed_root";
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -90 -85.240057211307061 90 ;
createNode joint -n "camSpeed" -p "camSpeed_root";
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 4.7599427886929409 90 0 ;
...
createNode script -n "sceneConfigurationScriptNode";
	setAttr ".b" -type "string" "playbackOptions -min 1 -max 300 -ast 1 -aet 4630 ";
	setAttr ".st" 6;
...
createNode animCurveTL -n "camSpeed_translateX";
	setAttr ".tan" 3;
	setAttr -s 15 ".ktv[0:14]"  1 0 2 0 7 -0.83643720388735698 12 -0.97266367522321762
		 36 0 37 0 42 1.0938372398607885 47 1.3676701493234951 77 0 78 0 82 0.43715832148208844
		 95 0 96 0 102 -0.39509471166644045 120 0;
	setAttr -s 15 ".kit[0:14]"  2 3 1 3 2 3 1 3 
		1 3 3 3 3 3 3;
	setAttr -s 15 ".kot[0:14]"  2 1 1 3 3 1 1 3 
		1 1 3 3 1 3 3;
	setAttr -s 15 ".kwl[0:14]" no no yes yes no no yes yes no no yes yes 
		no yes yes;
	setAttr -s 15 ".kix[2:14]"  0.10129459202289581 0.1666666716337204 
		0.80000007152557373 0.033333301544189453 0.16387119889259338 0.16666674613952637 
		1.9001812934875488 0.033333301544189453 0.13333344459533691 0.43333339691162109 0.033333301544189453 
		0.20000004768371582 0.59999990463256836;
	setAttr -s 15 ".kiy[2:14]"  -0.35028240084648132 0 0.97266370058059692 
		0 0.49131837487220764 0 0 0 0 0 0 0 0;
	setAttr -s 15 ".kox[1:14]"  0.048183806240558624 0.10129454731941223 
		0.80000007152557373 0.033333301544189453 0.17109990119934082 0.16387027502059937 
		0.99999988079071045 1.9001812934875488 0.1221240907907486 0.43333339691162109 0.033333301544189453 
		0.15999254584312439 0.59999990463256836 0.59999990463256836;
	setAttr -s 15 ".koy[1:14]"  -0.34183931350708008 -0.35028201341629028 
		0 0 1.5045506954193115 0.49131566286087036 0 0 0.64883393049240112 0 0 -0.96770143508911133 
		0 0;
createNode animCurveTL -n "camSpeed_translateY";
	setAttr ".tan" 3;
	setAttr -s 14 ".ktv[0:13]"  1 0 2 0 7 -0.14451235494784109 12 -0.03333947042090285
		 36 0 37 0 42 -0.2312265703701476 47 -0.27944891348528866 77 0 78 0 95 0 96 0 102 0.041051563928145622
		 120 0;
	setAttr -s 14 ".kit[0:13]"  2 3 3 1 2 3 1 3 
		3 2 3 3 3 3;
	setAttr -s 14 ".kot[0:13]"  2 1 3 1 3 1 1 3 
		3 2 3 2 3 3;
	setAttr -s 14 ".kwl[0:13]" no no yes yes no no yes yes yes no yes no 
		yes yes;
	setAttr -s 14 ".kix[3:13]"  0.11107222735881805 0.80000007152557373 
		0.033333301544189453 0.15303434431552887 0.16666674613952637 0.99999988079071045 
		0.033333301544189453 0.56666684150695801 0.033333301544189453 0.20000004768371582 
		0.59999990463256836;
	setAttr -s 14 ".kiy[3:13]"  0.082578882575035095 0.033339470624923706 
		0 -0.11022520065307617 0 0 0 0 0 0 0;
	setAttr -s 14 ".kox[1:13]"  0.0088202664628624916 0.1666666716337204 
		0.33321759104728699 0.033333301544189453 0.11985498666763306 0.15303349494934082 
		0.99999988079071045 0.033333301544189453 0.56666684150695801 0.033333301544189453 
		0.20000004768371582 0.59999990463256836 0.59999990463256836;
	setAttr -s 14 ".koy[1:13]"  -0.11060568690299988 0 0.24773743748664856 
		0 -0.23447509109973907 -0.11022458225488663 0 0 0 0 0.041051562875509262 0 0;
createNode animCurveTL -n "camSpeed_translateZ";
	setAttr ".tan" 2;
	setAttr -s 9 ".ktv[0:8]"  1 0 7 0 36 0 37 0 77 0 78 0 95 0 96 0 120 0;
	setAttr -s 9 ".kit[3:8]"  3 3 2 3 3 3;
	setAttr -s 9 ".kot[2:8]"  3 2 3 2 3 2 3;
	setAttr -s 9 ".kwl[0:8]" no yes no no yes no yes no yes;
createNode animCurveTU -n "camSpeed_visibility";
	setAttr ".tan" 9;
	setAttr -s 9 ".ktv[0:8]"  1 1 7 1 36 1 37 1 77 1 78 1 95 1 96 1 120 1;
	setAttr -s 9 ".kit[4:8]"  3 9 9 9 3;
	setAttr -s 9 ".kot[0:8]"  5 5 5 5 3 5 5 5 
		3;
	setAttr -s 9 ".kwl[3:8]" no yes yes yes no yes;
createNode animCurveTA -n "camSpeed_rotateX";
	setAttr ".tan" 3;
	setAttr -s 15 ".ktv[0:14]"  1 0 2 0 7 4.2394414550645081 12 1.7210337790429211
		 36 0 37 0 42 -3.7996654690424672 47 -2.1341615892993642 77 0 78 0 82 -2.0827546937776389
		 95 0 96 0 102 -1.5282407809458507 120 0;
	setAttr -s 15 ".kit[3:14]"  1 1 3 1 1 3 3 3 
		3 3 3 3;
	setAttr -s 15 ".kot[1:14]"  1 3 1 3 1 1 1 3 
		1 3 3 1 3 3;
	setAttr -s 15 ".ktl[1:14]" no yes yes yes yes yes yes yes yes yes yes 
		yes yes yes;
	setAttr -s 15 ".kwl[0:14]" no no yes yes no no yes yes yes no yes yes 
		no yes yes;
	setAttr -s 15 ".kix[3:14]"  0.004999114666134119 0.80705565214157104 
		0.033333301544189453 0.16222892701625824 0.035064708441495895 0.99999988079071045 
		0.033333301544189453 0.13333344459533691 0.43333339691162109 0.033333301544189453 
		0.20000004768371582 0.59999990463256836;
	setAttr -s 15 ".kiy[3:14]"  -0.0015388603787869215 0.00012154920113971457 
		0 -0.015518567524850368 0.012624365277588367 0 0 0 0 0 0 0;
	setAttr -s 15 ".kox[1:14]"  0.051736775785684586 0.1666666716337204 
		0.33827218413352966 0.033333301544189453 0.14227578043937683 0.16222797334194183 
		0.53500586748123169 0.033333301544189453 0.10978420078754425 0.43333339691162109 
		0.033333301544189453 0.17165626585483551 0.59999990463256836 0.59999990463256836;
	setAttr -s 15 ".koy[1:14]"  0.044691514223814011 0 -0.10412921011447906 
		0 -0.101056769490242 -0.015518475323915482 0.19261835515499115 0 -0.040227252990007401 
		0 0 -0.036421287804841995 0 0;
createNode animCurveTA -n "camSpeed_rotateY";
	setAttr ".tan" 2;
	setAttr -s 9 ".ktv[0:8]"  1 0 7 0 36 0 37 0 77 0 78 0 95 0 96 0 120 0;
	setAttr -s 9 ".kit[3:8]"  3 3 2 3 3 3;
	setAttr -s 9 ".kot[2:8]"  3 2 3 2 3 2 3;
	setAttr -s 9 ".kwl[0:8]" no yes no no yes no yes no yes;
createNode animCurveTA -n "camSpeed_rotateZ";
	setAttr ".tan" 2;
	setAttr -s 9 ".ktv[0:8]"  1 0 7 0 36 0 37 0 77 0 78 0 95 0 96 0 120 0;
	setAttr -s 9 ".kit[3:8]"  3 3 2 3 3 3;
	setAttr -s 9 ".kot[2:8]"  3 2 3 2 3 2 3;
	setAttr -s 9 ".kwl[0:8]" no yes no no yes no yes no yes;
createNode animCurveTU -n "camSpeed_scaleX";
	setAttr ".tan" 2;
	setAttr -s 9 ".ktv[0:8]"  1 1 7 1 36 1 37 1 77 1 78 1 95 1 96 1 120 1;
	setAttr -s 9 ".kit[4:8]"  3 2 2 2 3;
	setAttr -s 9 ".kot[4:8]"  3 2 2 2 3;
	setAttr -s 9 ".kwl[3:8]" no yes yes yes no yes;
createNode animCurveTU -n "camSpeed_scaleY";
	setAttr ".tan" 2;
	setAttr -s 9 ".ktv[0:8]"  1 1 7 1 36 1 37 1 77 1 78 1 95 1 96 1 120 1;
	setAttr -s 9 ".kit[4:8]"  3 2 2 2 3;
	setAttr -s 9 ".kot[4:8]"  3 2 2 2 3;
	setAttr -s 9 ".kwl[3:8]" no yes yes yes no yes;
createNode animCurveTU -n "camSpeed_scaleZ";
	setAttr ".tan" 2;
	setAttr -s 9 ".ktv[0:8]"  1 1 7 1 36 1 37 1 77 1 78 1 95 1 96 1 120 1;
	setAttr -s 9 ".kit[4:8]"  3 2 2 2 3;
	setAttr -s 9 ".kot[4:8]"  3 2 2 2 3;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -k on ".gh";
	setAttr -cb on ".sd";
connectAttr "camSpeed_root.s" "camSpeed.is";
connectAttr "camSpeed_translateX.o" "camSpeed.tx";
connectAttr "camSpeed_translateY.o" "camSpeed.ty";
connectAttr "camSpeed_translateZ.o" "camSpeed.tz";
connectAttr "camSpeed_visibility.o" "camSpeed.v";
connectAttr "camSpeed_rotateX.o" "camSpeed.rx";
connectAttr "camSpeed_rotateY.o" "camSpeed.ry";
connectAttr "camSpeed_rotateZ.o" "camSpeed.rz";
connectAttr "camSpeed_scaleX.o" "camSpeed.sx";
connectAttr "camSpeed_scaleY.o" "camSpeed.sy";
connectAttr "camSpeed_scaleZ.o" "camSpeed.sz";
