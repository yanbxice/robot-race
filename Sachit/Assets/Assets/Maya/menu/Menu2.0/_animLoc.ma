...
//Name: _animLoc.ma
//Last modified: Wed, Jul 11, 2012 06:17:04 PM
//Codeset: 1252
requires maya "2012";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 39.590382816834989 11.858104929637086 4.551370657370617 ;
	setAttr ".r" -type "double3" -18.988680957570594 77.400000000002876 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 41.806630846061132;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "_animNode";
createNode locator -n "_animNodeShape" -p "_animNode";
	setAttr -k off ".v";
createNode lightLinker -s -n "lightLinker1";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode displayLayerManager -n "layerManager";
	setAttr -s 6 ".dli[1:5]"  13 14 16 17 18;
	setAttr -s 6 ".dli";
...
createNode animCurveTL -n "_animNode_translateX";
	setAttr ".tan" 2;
	setAttr -s 8 ".ktv[0:7]"  1 0 15 0 17 0 23 0 29 0 30 -5000 45 -5000
		 46 0;
createNode animCurveTL -n "_animNode_translateY";
	setAttr ".tan" 2;
	setAttr -s 8 ".ktv[0:7]"  1 0 15 0 17 0 23 0 29 0 30 -5000 45 -5000
		 46 0;
createNode animCurveTL -n "_animNode_translateZ";
	setAttr ".tan" 2;
	setAttr -s 8 ".ktv[0:7]"  1 0 15 0 17 0 23 0 29 0 30 -5000 45 -5000
		 46 0;
createNode animCurveTU -n "_animNode_visibility";
	setAttr ".tan" 9;
	setAttr -s 6 ".ktv[0:5]"  1 1 15 1 17 1 23 1 45 1 46 1;
	setAttr -s 6 ".kot[0:5]"  5 5 5 5 5 5;
createNode animCurveTA -n "_animNode_rotateX";
	setAttr ".tan" 2;
	setAttr -s 6 ".ktv[0:5]"  1 0 15 0 17 0 23 0 45 0 46 0;
createNode animCurveTA -n "_animNode_rotateY";
	setAttr ".tan" 2;
	setAttr -s 6 ".ktv[0:5]"  1 0 15 0 17 0 23 0 45 0 46 0;
createNode animCurveTA -n "_animNode_rotateZ";
	setAttr ".tan" 2;
	setAttr -s 6 ".ktv[0:5]"  1 0 15 0 17 0 23 0 45 0 46 0;
createNode animCurveTU -n "_animNode_scaleX";
	setAttr ".tan" 2;
	setAttr -s 6 ".ktv[0:5]"  1 1 15 1 17 1 23 1 45 1 46 1;
createNode animCurveTU -n "_animNode_scaleY";
	setAttr ".tan" 2;
	setAttr -s 22 ".ktv[0:21]"  1 1 15 1 17 0.83558767348278584 18 0.82685386828756624
		 20 0.27742840370220706 22 0.76696384345198543 23 0.80106818047407558 24 0.13047011120669444
		 26 0.20678172368852563 28 0.030805852058340397 29 0.013033951875198374 45 0.013033951875198374
		 46 0.013033951875198374 48 0.070314919309273624 49 0.078811445800635413 51 0.057078382585352368
		 53 0.91391113607567809 54 0.9444580754488201 56 0.36625550561063097 57 0.33422714134320503
		 59 0.67543883679816763 60 1;
createNode animCurveTU -n "_animNode_scaleZ";
	setAttr ".tan" 2;
	setAttr -s 21 ".ktv[0:20]"  1 1 15 1 17 0.31212581618896562 18 0.29301872895405418
		 20 0.82060593690712502 22 0.95066539842519449 23 0.98618561034435126 24 0.79965320212826707
		 26 0.90016956992216912 28 0.34892063756582337 29 0.046927712272950228 45 0.046927712272950228
		 46 0.046927712272950228 48 0.89849917192721096 49 0.94239591054625405 51 0.2834767409816944
		 53 0.39968977172034148 54 0.44086142581719745 56 0.62446967139809095 57 0.66147071565884574
		 60 1;
select -ne :time1;
	setAttr ".o" 31;
	setAttr ".unw" 31;
...
connectAttr "_animNode_translateX.o" "_animNode.tx";
connectAttr "_animNode_translateY.o" "_animNode.ty";
connectAttr "_animNode_translateZ.o" "_animNode.tz";
connectAttr "_animNode_visibility.o" "_animNode.v";
connectAttr "_animNode_rotateX.o" "_animNode.rx";
connectAttr "_animNode_rotateY.o" "_animNode.ry";
connectAttr "_animNode_rotateZ.o" "_animNode.rz";
connectAttr "_animNode_scaleX.o" "_animNode.sx";
connectAttr "_animNode_scaleY.o" "_animNode.sy";
connectAttr "_animNode_scaleZ.o" "_animNode.sz";
