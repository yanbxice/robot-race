...
function execute () 
{
	...
	if (DataTransfer.credits >= DataTransfer.botPrice[DataTransfer.activeBot - 1])
	{
...
function Update()
{
	priceLabel.text = "for " + DataTransfer.botPrice[DataTransfer.activeBot - 1];
}