...
public abstract class SamUIAbstractContainer : SamUIObject, IPositionable
{
	public enum SamUILayoutType { Horizontal, Vertical, BackgroundLayout, AbsoluteLayout };
	private SamUILayoutType _layoutType;
	public SamUILayoutType layoutType { get { return _layoutType; } set { _layoutType = value; layoutChildren(); } } // relayout when layoutType changes
	...
	public SamUIEdgeInsets _edgeInsets; // pixel padding insets for top, left, bottom and right
	public SamUIEdgeInsets edgeInsets { get { return _edgeInsets; } set { _edgeInsets = value; layoutChildren(); } } // relayout when edgeInsets changes
	...
	protected List<SamUISprite> _children = new List<SamUISprite>();
	...
	/// </summary>
	public SamUIAbstractContainer() : this( SamUILayoutType.Vertical )
	{}
	...
	/// </summary>
	public SamUIAbstractContainer( SamUILayoutType layoutType )
	{
	...
	/// <summary>
	/// Adds a SamUISprite to the container and sets it to lay itself out
	/// </summary>
	public virtual void addChild( params SamUISprite[] children )
	{
		foreach( var child in children )
		{
			child.parentSamUIObject = this;
			_children.Add( child );
		}
	...
	/// </summary>
	public void removeChild( SamUISprite child, bool removeFromManager )
	{
#if UNITY_EDITOR
		// sanity check while we are in the editor
		if( !_children.Contains( child ) )
			throw new System.Exception( "could not find child in SamUIAbstractContainer: " + child );
#endif
	...
	protected virtual void layoutChildren()
	{
		...
		if( _layoutType == SamUIAbstractContainer.SamUILayoutType.Horizontal || _layoutType == SamUIAbstractContainer.SamUILayoutType.Vertical )
		{
			...
			if( _layoutType == SamUIAbstractContainer.SamUILayoutType.Horizontal )
			{
				var i = 0;
		...
		else if( _layoutType == SamUIAbstractContainer.SamUILayoutType.AbsoluteLayout )
		{
			foreach( var item in _children )
			{
