...
public class SamUIScrollableVerticalLayout : SamUIAbstractTouchableContainer
{
	...
	private float TOUCH_MAX_DELTA_FOR_ACTIVATION = SamUI.instance.isHD ? 10 : 5;
	private const float CONTENT_TOUCH_DELAY = 0.15f;
	
	private float _deltaTouch;
#if UNITY_EDITOR || UNITY_STANDALONE_OSX || UNITY_STANDALONE_WIN || UNITY_WEBPLAYER
	private SamUIFakeTouch _lastTouch;
#else
	...
	public SamUIScrollableVerticalLayout( int spacing ) : base( SamUILayoutType.Vertical, spacing )
	{
