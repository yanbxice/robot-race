...
// addTextInstance (from the SamUIText class) returns one of these so we just need to do a .text on the instance to update it's text
public class SamUITextInstance : SamUIObject
{
	private SamUIText _parentText;
	private string _text;
	public SamUITextAlignMode alignMode;
	public SamUITextVerticalAlignMode verticalAlignMode;
	...
	public int depth;
	public Color[] colors;
	public List<SamUISprite> textSprites = new List<SamUISprite>(); // all the sprites that make up the string
	...
	/// <summary>
	/// Call the full constructor with default alignment modes brought from the parent SamUIText object.
	/// </summary>
	public SamUITextInstance( SamUIText parentText, string text, float xPos, float yPos, float scale, int depth, Color color ) : this( parentText, text, xPos, yPos, scale, depth, new Color[] { color }, parentText.alignMode, parentText.verticalAlignMode )
	{}
	...
	/// </summary>
	public SamUITextInstance( SamUIText parentText, string text, float xPos, float yPos, float scale, int depth, Color[] colors, SamUITextAlignMode alignMode, SamUITextVerticalAlignMode verticalAlignMode ) : base()
	{
	...
	/// </summary>
	public SamUISprite textSpriteAtIndex( int index )
	{
	...
	/// <summary>
	/// Destroys the SamUITextInstance object and its sprites
	/// </summary>
	public void destroy()
	{
	clear();
