...
public class SamUIToolkit : SamUISpriteManager
{
	// All access should go through instance
	static public SamUIToolkit instance = null;
	...
	{
/* ALEX DISABLE SamUITOOLKIT TOUCH HANDLING	
		...
		if( Input.touchCount > 0 )
		{
			...
			{
//#if UNITY_EDITOR || UNITY_STANDALONE_OSX || UNITY_STANDALONE_WIN || UNITY_WEBPLAYER
				lookAtTouch( SamUIFakeTouch.fromTouch( Input.GetTouch( i ) ) );
//# else
...
//# if UNITY_EDITOR || UNITY_STANDALONE_OSX || UNITY_STANDALONE_WIN || UNITY_WEBPLAYER
		else
		{
			...
			if( Input.GetMouseButton( 0 ) || Input.GetMouseButtonUp( 0 ) )
				lookAtTouch( SamUIFakeTouch.fromInput( ref lastMousePosition ) );
...
//#endif
*/ // ALEX END DISABLE SamUITOOLKIT TOCH
	...
	void OnDrawGizmos()
	{
		...
		else
		{
			...
			if( Input.GetMouseButton( 0 ) )
			{
				...
				var touch = SamUIFakeTouch.fromInput( ref fakeVec );
				var pos = _uiCamera.ScreenToWorldPoint( touch.position );
				Gizmos.DrawCube( pos, new Vector3( 20, 20, 5 ) );
			}
		}
	...
	{
		if( touchableSprite is SamUISprite )
			addSprite( touchableSprite as SamUISprite );
			
		// Add the sprite to our touchables and sort them		
		_touchableSprites.Add( touchableSprite as ITouchable );
		
		// TODO: why does this not work with SamUIAbstractTouchableContainer?
	...
	/// Removes a sprite
	/// </summary>
	public void removeElement( SamUISprite sprite )
	{
...
#if UNITY_EDITOR || UNITY_STANDALONE_OSX || UNITY_STANDALONE_WIN || UNITY_WEBPLAYER
	private void lookAtTouch( SamUIFakeTouch touch )
#else
